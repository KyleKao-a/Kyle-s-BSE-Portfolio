...
For example, the console can translate your pressing the right button of the arcade into the action of moving the tetris piece to the right as when the button is pressed, it sends a signal onto the IC Chip which translates the signal into an action onto the LED Matrix, which allows the player to see that the tetris piece moves to the right.

A challenging aspect of this project is soldering the many components of the arcade console. Since I am inexperienced with soldering, soldering the smaller holes was hard to do. I also initially panicked as I failed to follow instructions properly and had to restart the project in the beginning thinking that I was now wildly behind. Thankfully I was able to finish the starter project on time, and this project has taught me meaningful soldering skills and to keep my composure even in the face of hardship and difficulty. 
